...
export default defineConfig({
  ...
  fullyParallel: true,
  timeout : 90000,  // 40 seconds for each test
  ...
  use: {
    ...
    actionTimeout: 10000, // Default timeout for each action (e.g. click, fill, etc.)
    headless: false,
    baseURL: 'https://dailyfinance.roadtocareer.net/', // Base URL for the tests
